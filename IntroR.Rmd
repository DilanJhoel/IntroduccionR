...
poblaci�n_paises_america <- data.frame(identador = seq(1:12), norte_sur = as.factor(c(rep(0, 10), 1, 1)), paises = c("Argentina", "Bolivia","Brasil", "Chile", "Colombia", "Ecuador", "Paraguay", "Per�", "Surinam", "Guyana", "USA", "M�xico"), poblaci�n = c(45.38, 11.67, 212.6, 19.12, 50.88, 17.64, 0.79, 32.12, 329.5, 128.9, 350.5, 84.25)) #millones
```
